...
export function ProjectsPage() {
    ...
    return (_jsxs(Stack, { spacing: 3, children: [_jsxs(Stack, { direction: "row", justifyContent: "space-between", alignItems: "flex-start", gap: 2, children: [_jsxs(Box, { children: [_jsx(Typography, { variant: "h4", fontWeight: 700, children: "\u041F\u0440\u043E\u0435\u043A\u0442\u044B" }), _jsx(Typography, { variant: "body2", color: "text.secondary", sx: { mt: 0.6, maxWidth: 760 }, children: "\u0420\u0430\u0431\u043E\u0447\u0435\u0435 \u043F\u0440\u043E\u0441\u0442\u0440\u0430\u043D\u0441\u0442\u0432\u043E \u0441 \u0434\u0440\u0435\u0432\u043E\u0432\u0438\u0434\u043D\u043E\u0439 \u0441\u0442\u0440\u0443\u043A\u0442\u0443\u0440\u043E\u0439 \u043F\u0430\u043F\u043E\u043A, \u043F\u0440\u043E\u0435\u043A\u0442\u0430\u043C\u0438 \u0438 drag&drop \u0443\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u0435\u043C \u043A\u0430\u043A \u0432 \u0444\u0430\u0439\u043B\u043E\u0432\u043E\u043C \u043D\u0430\u0432\u0438\u0433\u0430\u0442\u043E\u0440\u0435." })] }), user?.role === "admin" && (_jsx(IconButton, { onClick: openActionsMenu, sx: {
                ...
                }, children: _jsxs(Stack, { spacing: 2, children: [_jsxs(Stack, { direction: { xs: "column", lg: "row" }, spacing: 1.5, alignItems: { lg: "center" }, justifyContent: "space-between", children: [_jsxs(Stack, { direction: "row", spacing: 1, flexWrap: "wrap", children: [_jsx(Chip, { label: `Проектов: ${treeStats.totalProjects}`, variant: "outlined" }), _jsx(Chip, { label: `Папок: ${treeStats.totalFolders}`, variant: "outlined" }), _jsx(Chip, { label: `Вложенных папок: ${treeStats.nestedFolders}`, variant: "outlined" })] }), _jsx(Typography, { variant: "caption", color: "text.secondary", children: "\u041F\u043E\u0434\u0441\u0432\u0435\u0442\u043A\u0430 \u043F\u0430\u043F\u043A\u0438 \u043E\u0437\u043D\u0430\u0447\u0430\u0435\u0442 \u0432\u043B\u043E\u0436\u0435\u043D\u0438\u0435 \u0432\u043D\u0443\u0442\u0440\u044C, \u043B\u0438\u043D\u0438\u044F \u043C\u0435\u0436\u0434\u0443 \u044D\u043B\u0435\u043C\u0435\u043D\u0442\u0430\u043C\u0438 \u043E\u0437\u043D\u0430\u0447\u0430\u0435\u0442 \u043F\u0435\u0440\u0435\u043D\u043E\u0441 \u043D\u0430 \u044D\u0442\u043E\u0442 \u0443\u0440\u043E\u0432\u0435\u043D\u044C." })] }), _jsxs(Stack, { direction: { xs: "column", md: "row" }, spacing: 1.5, children: [_jsx(TextField, { label: "\u041F\u043E\u0438\u0441\u043A \u043F\u0440\u043E\u0435\u043A\u0442\u0430", placeholder: "\u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0438\u043B\u0438 \u043E\u043F\u0438\u0441\u0430\u043D\u0438\u0435", value: searchQuery, onChange: (event) => setSearchQuery(event.target.value), fullWidth: true }), _jsxs(TextField, { select: true, label: "\u0421\u0442\u0430\u0442\u0443\u0441", value: statusFilter, onChange: (event) => setStatusFilter(event.target.value), sx: { minWidth: 220 }, children: [_jsx(MenuItem, { value: "all", children: "\u0412\u0441\u0435 \u0441\u0442\u0430\u0442\u0443\u0441\u044B" }), _jsx(MenuItem, { value: "active", children: "active" }), _jsx(MenuItem, { value: "completed", children: "completed" }), _jsx(MenuItem, { value: "archived", children: "archived" })] })] })] }) }), _jsxs(List, { ref: projectListRef, disablePadding: true, onDragOver: (event) => {
                    const dragging = parseDragPayload(event);
                    if (!dragging) {
                        stopAutoScroll();
                        return;
